...
void SwapChain::InitializeSwapChain(glm::uvec2 screenSize)
{
     ...
     VkCheckResult(_vulkanContext->Device().createSwapchainKHR(&createInfo, nullptr, &_swapChain), "[VULKAN] Failed creating swap chain!");
...
void SwapChain::InitializeImageViews()
{
     ...
     for (size_t i = 0; i < _imageViews.size(); ++i)
     {
         ...
         VkCheckResult(_vulkanContext->Device().createImageView(&createInfo, nullptr, &_imageViews[i]), "[VULKAN] Failed creating image view for swap chain!");
